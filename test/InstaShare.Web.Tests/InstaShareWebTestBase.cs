...
{
    public abstract class InstaShareWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InstaShareWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InstaShareWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InstaShareDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InstaShareDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InstaShareDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InstaShareDbContext, Task<T>> func)
        {
            T result;
